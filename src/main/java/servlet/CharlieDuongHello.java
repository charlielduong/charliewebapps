...
@WebServlet(name = "FirstServlet", urlPatterns = {"/CharlieDuongHello"})
public class CharlieDuongHello extends HttpServlet // Inheriting from HttpServlet makes this a servlet
{
