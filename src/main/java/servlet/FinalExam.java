...
public class FinalExam extends HttpServlet // Inheriting from HttpServlet makes this a servlet
{
    ...
    private void printBody(PrintWriter out) {
        ...
        out.println("          <td>");
        out.println(
                "            <input style='width: 100%;' id='gen' type='button' class='primary' value='Generate' onclick='generateButton()'>");
        out.println("          </td>");
        out.println("        </tr>");
        ...
        out.println(
                "            <input type='submit' class='primary' value='Submit' style='width: fit-content; width: 100%; margin-bottom: 5px;' onclick='checkInputs();'>");
        out.println("            <br>");
        out.println(
    ...
    private void printEC(HttpServletRequest request, PrintWriter out) {
        ...
        for (int i = 0; i < values.length; i++) {
            if (Integer.parseInt(values[i]) > maxCharacteristics) {
                maxCharacteristics = Integer.parseInt(values[i]);
            }
        }
